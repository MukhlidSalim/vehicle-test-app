    ...
    <div className="relative flex items-center justify-center">
      ...
      */}
      <img 
        ...
        alt="VIS System Logo" 
        className="h-16 md:h-20 w-auto object-contain transition-transform duration-300 md:group-hover:scale-110"
      />
      ...
      */}
      <div className="absolute -top-1 -right-2 flex items-center justify-center scale-[0.6] opacity-0 md:group-hover:opacity-100 transition-opacity duration-500">
