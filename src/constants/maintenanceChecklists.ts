...
export const MAINTENANCE_SMALL_BUS_CHECKLIST = [
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(0, 50),
  { id: 51, key: 'communication_device', icon: Radio },
  { id: 52, key: 'load_securing', icon: LuggageIcon },
];

export const MAINTENANCE_AMBULANCE_CHECKLIST = [
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(0, 49),
...
export const MAINTENANCE_LIGHT_VEHICLE_CHECKLIST = [
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(0, 8),
  { id: 9, key: 'general_interior', icon: ShieldCheck },
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(9, 40),
  { id: 41, key: 'sun_visors', icon: ShieldCheck },
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(41, 46),
  { id: 47, key: 'warning_triangle', icon: AlertTriangle },
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(47, 48),
  { id: 49, key: 'rear_camera', icon: Camera },
  { id: 50, key: 'safety_signage', icon: ShieldAlert },
  { id: 51, key: 'entertainment_system', icon: Music },
  { id: 52, key: 'load_securing', icon: LuggageIcon },
];
...
export const MAINTENANCE_PICKUP_CHECKLIST = [
  ...
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(9, 30),
  { id: 31, key: 'cargo_area', icon: Truck },
  { id: 32, key: 'cargo_tie_downs', icon: Anchor },
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(32, 40),
...
export const MAINTENANCE_ELECTRIC_CHECKLIST = [
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(0, 8),
  { id: 9, key: 'general_interior', icon: ShieldCheck },
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(9, 20),
  { id: 21, key: 'high_voltage_battery', icon: BatteryCharging },
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(21, 23),
  { id: 24, key: 'battery_coolant', icon: Thermometer },
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(24, 25),
  { id: 26, key: 'charging_cable', icon: PlugZap },
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(26, 40),
  { id: 41, key: 'sun_visors', icon: ShieldCheck },
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(41, 46),
  { id: 47, key: 'warning_triangle', icon: AlertTriangle },
  ...MAINTENANCE_HEAVY_BUS_CHECKLIST.slice(47, 48),
  { id: 49, key: 'regen_braking', icon: Zap },
  { id: 50, key: 'safety_signage', icon: ShieldAlert },
  { id: 51, key: 'bms_system', icon: Monitor },
  { id: 52, key: 'frunk', icon: ShieldCheck },
];
